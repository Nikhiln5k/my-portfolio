    ...
    <>
        <div style={{overflow:"hidden", position:"relative"}}>
          <main
            ...
            style={{ borderBottomLeftRadius: "100px", borderBottomRightRadius: "100px", zIndex:"0",position:"relative" }}
          >
            <div className="d-flex relative">
              ...
              <div className='contact' style={{marginLeft:"6rem",marginTop:"2rem",position:"absolute",zIndex:"1",transform:"rotate(-15deg)"}}>
                <button className='bg-light text-dark fw-bold' style={{fontSize:"10px"}}>Hey Iam Nikhil 👋🏼</button>
              </div>
            </div>
            ...
            <div>
              <a href='mailto:nikhilsk289@gmail.com' className="primary-btn d-flex align-items-center" style={{ pointerEvents: "auto" }}>
